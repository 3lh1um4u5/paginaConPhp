 ...
 <body class="" style="background-color:black;color:white">
 	<center> 
        <h1>Historia de los comics</h1>
        </center>
        <br>  

            <p class="letras"> La historia del cómic o historieta es controvertida, dado que existe una fuerte discusión sobre sus inicios, en función de si se usa una definición más o menos restrictiva.
              <br>
            ...
            <br>  
            <h2 class="mish">Antes de la imprenta</h2>
            <p class="letras"> La necesidad de comunicación más allá de la comunicación oral directa fomenta la aparición de varios sistemas de representación gráfica más o menos estandarizados ( pictogramas) que en algunos casos acabarían evolucionando en forma de escritura ( véase: historia de la escritura). En Mesopotamia, ya hacia el 8.500aC, están los llamados calculi, unas fichas de arcilla con diversas formas geométricas y representaciones de animales que se guardaban en recipientes tapados, posiblemente para contabilizar las cosechas y el ganado,posteriormente aparecen los sellos cilíndricos, que servían para imprimir símbolos y dibujos sobre arcilla o soportes similares (encontramos un sistema similar en la cultura del valle del Indo). Estos sellos se van perfeccionando y adquieren más detalle y complejidad durante las primeras dinastías sumerias, también se añaden separaciones entre las franjas de los dibujos, formando una tira.
            </p>
            <br>  
            ...
            <img src="img/son.png" alt="son" >
              ...
              <br>  
              <p class="letras"> 
                La imprenta es el punto de partida de la historia del cómic para especialistas como David Kunzle6​ o Pedro Porcel.7​ Ésta se introdujo en Occidente gracias a Gutenberg en 1446, y ya desde el siglo XVI, en Francia, y luego otros países, comienzan a difundirse los pliegos de cordel y las aleluyas. Fuera de ésta, también suelen citarse El Primer Nueva coronica y buen gobierno (hacia 1615) de Felipe Guamán Poma de Ayala8​ o las pinturas en serie del inglés William Hogarth (1697–1764), como A Harlot’s Progress (1732), A Rake’s Progress (1735) y Marriage A-la-mode (1745).

                Fueron los humoristas gráficos ingleses del XVIII, como Isaac Cruikshank, los que desarrollaron el globo de diálogo en sus caricaturas para satirizar a sus gobernantes, pero probablemente el primer libro de historietas sea “Lenardo und Blandine” (1783) de Josef Franz von Goez.9​ La reproducción masiva del dibujo tampoco fue posible hasta 1789, año en que se inventó la litografía, ya que esta permite la impresión directa sobre la página sin ningún proceso humano intermedio, gracias a planchas resistentes a múltiples prensados. En 1796, Jean-Charles Pellerin inicia en Francia, concretamente en la región de Épinal, una industria de producción de estampas conocida como imágenes de Épinal.

                Entre los pioneros de la primera mitad del siglo XIX, suelen citarse a Nordquist, Bilderdijk, Thomas Rowlandson (Dr Syntax), William Chacón y George Cruikshank,10​ aunque el popularizador del cómic moderno es el franco-suizo Rodolphe Töpffer, quien publica en 1833 su Histoire de M. Jabot, a la que seguirían otros seis álbumes. Su Ensayo sobre fisionomía de 1845 es considerado como el primer texto teórico del medio.        
                 </p>
                  <p  align="center"class="imgs" > 
                  <img src="img/ejem.jpg " alt="ejemp" width="200px  " height=" 300px ">    "Imagen de Epinal del siglo XIX"                                                    
                </p>
                <br>  
              <h2 class="mish"> En la prensa de masas</h2>
              <br>  
              <p class="letras" >Hay estudios que consideran la historieta como un producto cultural de la modernidad industrial y política occidental que surgió en paralelo a la evolución de la prensa como primer medio de comunicación de masas, y buscan la primera entre las reproducidas en las revistas gráficas.
                <br>  
            ...
            Inspirada en Le Charivari, la revista británica Punch (1841) fue el motor de la expansión mundial de la historieta al dirigirse a un nuevo sector aupado también por la revolución social e industrial: la infancia. El modelo de Punch fue imitado en todo el mundo, dando lugar en Alemania a Fliegende Blätter (1844) en la que debutaría el excepcional Wilhelm Busch, autor de Max und Moritz (1865); en Japón, a The Japan Punch (1862-87), y, lo que es más importante, en Estados Unidos, a Puck (1877), Judge (1881) y Life (1883), verdaderos campos de prueba en los que comenzaron, entre otros, Richard Felton Outcault y Frederick Burr Opper.
                <br> 
            Surgen también series con personajes fijos, como Ally Sloper, creado en 1867 para la revista británica Judy; Famille Fenouillard, creada por Christophe para Le Petit Français illustré en 1889, y Little Bears and Tigers, del estadounidense James Swinnerton en 1892. Al año siguiente, se incorpora el color en el suplemento dominical del New York World de Pulitzer. </p>
                <br>  

            <h2 class="mish"> La modernidad (1895-1928)</h2>
            <p class="letras"> 
              En los albores del siglo XX el principal centro de producción e innovación en el campo de la historieta fue EE.UU, ya que los principales editores del país, Hearst y Pulitzer, la usaron para atraer a todo tipo de público, niños y adultos, incluyendo a los inmigrantes que no sabían inglés.14​ Llegaron hasta a luchar en los tribunales por su posesión y los tribunales sentenciaron en 1913 que un autor debía renombrar su serie si se pasaba con ella a otro periódico. W. R. Hearst también impulsó los recopilatorios de tiras y en 1914 fundó el Kings Feature Syndicate, la primera agencia para su distribución.
              <br>  

              Las series germinales fueron Hogan's Alley (1895) de Outcault, protagonizada por The Yellow Kid,15​The Katzenjammer Kids (1897) de Rudolph Dirks, inspirada en Max y Moritz] de Busch, y Happy Hooligan (1899) de Frederick Burr Opper, que se sirven progresivamente de los globos de diálogo.16​
              <br>  
              ...
              <br>  
              En el resto del mundo, mientras tanto, siendo de destacar las originales novelas sin palabras de Frans Masereel17​ y el surgimiento de revistas y suplementos infantiles como las británicas Chip y Comic Cuts, ambas de 1890; la brasileña "O Tico-Tico" (1905), la italiana Corriere dei piccoli (1908), la española TBO (1917) y la argentina Billiken (1919). En Japón, tras la labor pionera de Rakuten Kitazawa, triunfan historietas infantiles como Las aventuras de Shochan(1923) de Shousei Oda/Tofujin y Los Tres Mosqueteros con botas en la cabeza (1930) de Taisei Makino/Suimei Imoto18​El uso internacional de los globos no se generalizaría hasta la belga Zig et Puce (1925) de Alain Saint-Ogan.
            </p>
                <br>  
